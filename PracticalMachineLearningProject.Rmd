...
Based on the confusion matrix, the accuracy is .5004, meaning the out-of-sample error rate is about .5.  
...
```
For this set of data, the random forest method is a much better method than the classification tree method.  The overall accuracy is .9997, making the out-of-sample error rate about .0003.
